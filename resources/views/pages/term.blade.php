        ...
        <div class="page-container">
            ...
            <div class="columns is-vcentered">
                ...
                <div class="column is-12 is-12-desktop">
                    ...
                    <h1 class="h2-title">Terms and Conditions (&quot;Terms&quot;)</h1>

                    <p class="text-intro">
                    Our Terms and Conditions were last updated on November 10, 2022. Please read these terms and conditions carefully before using Our Service.
                    </p>
        ...
        <div class="page-container">
            ...
            <div class="content">
                ...
                <ul>
                    ...
                    <li>
                        <p class="text">
                        <strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to We Share Our Workspace.
                        </p>
                    </li>
                    <li>
                        <p class="text">
                    ...
                    <li>
                        <p class="text">
                        <strong>Website</strong> refers to We Share Our Workspace, accessible from https://weshareourworkspace.com
                        </p>
                    </li>
                    <li>
                        <p class="text">
                ...
                <h2 class="h2-title">Acknowledgement</h2>
                <p class="text">
                ...
                <h2 class="h2-title">Links to Other Websites</h2>
                <p class="text">
                ...
                <h2 class="h2-title">Termination</h2>
                <p class="text">
                ...
                <h2 class="h2-title">&quot;AS IS&quot; and &quot;AS AVAILABLE&quot; Disclaimer</h2> 
                <p class="text">
                ...
                <h2 class="h2-title">Governing Law</h2>
                <p class="text">
                The laws of the Country, excluding its conflicts of law rules, shall govern this Terms and Your use of the Service. Your use of the Application may also be subject to other local, state, national, or international laws.
                </p>
                <h2 class="h2-title">Disputes Resolution</h2>
                <p class="text">
                If You have any concern or dispute about the Service, You agree to first try to resolve the dispute informally by contacting the Company.
                </p>
                <h2 class="h2-title">For European Union (EU) Users</h2>
                <p class="text">
                If You are a European Union consumer, you will benefit from any mandatory provisions of the law of the country in which you are resident in.
                </p>
                <h2 class="h2-title">United States Legal Compliance</h2>
                <p class="text">
                You represent and warrant that (i) You are not located in a country that is subject to the United States government embargo, or that has been designated by the United States government
                </p>
                <h2 class="h2-title">Severability and Waiver</h2>
                <h3 class="h3-title">Severability</h3>
                <p class="text">
                If any provision of these Terms is held to be unenforceable or invalid, such provision will be changed and interpreted to accomplish the objectives of such provision to the greatest extent possible under applicable law and the remaining provisions will continue in full force and effect.
                </p>
                <h3 class="h3-title">Waiver</h3>
                <p class="text">
                Except as provided herein, the failure to exercise a right or to require performance of an obligation under this Terms shall not effect a party&#39;s ability to exercise such right or require such performance at any time thereafter nor shall be the waiver of a breach constitute a waiver of any subsequent breach.
                </p>
                <h2 class="h2-title">Translation Interpretation</h2>
                <p class="text">
                ...
                <h2 class="h2-title">Changes to These Terms and Conditions</h2>
                <p class="text">
